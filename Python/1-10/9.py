...
print("Count do this :> ", sentence.upper().count("A"))
...
#########################################################
#Strip : will remove the right and left character (Space by default)
lite = sentence.center(50)
print(lite)
print("Strip do this :>",lite.strip())
    #Lstrip : will strinp the left
print("LeftStrip do this",lite.lstrip())
    #Rstrip
print("RightStrip will do this", lite.rstrip())
########################################################
